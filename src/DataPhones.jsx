...
export default function DataPhones() {
 ...
 {NewPhoneModelIndex ? (
  ...
  <div   className="fixed inset-0 bg-black/70 flex justify-center items-center animate__animated animate__fadeIn" onClick={() => setNewPhoneModelIndex(false)}>
    ...
    <div className="w-[500px] p-4 rounded bg-gray-700 shadow border flex flex-col items-center justify-center gap-4 animate__animated animate__slideInDown "
...
<dialog id="my_modal_1" className=" modal fixed inset-0 bg-black/70 flex justify-center items-center animate__animated animate__fadeIn " onClick={()=> document.querySelector('#my_modal_1').close() } >
  <div className="modal-box  w-[500px] p-4 rounded bg-gray-700 shadow border flex flex-col items-center justify-center gap-4 animate__animated animate__fast " onClick={(event)=> event.stopPropagation(false) }> 
